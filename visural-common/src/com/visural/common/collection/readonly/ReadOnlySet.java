...
/**
 * A set which wraps another set, but throws a
 * `UnsupportedOperationException` if the consumer attempts to modify it.
 *
 * @version $Id: ReadOnlySet.java 2 2009-11-17 12:26:31Z tibes80@gmail.com $
 * @author Richard Nichols
 */
public class ReadOnlySet<T> implements Set<T> {

    private final Set<T> baseCollection;

    public ReadOnlySet(Set<T> baseCollection) {
